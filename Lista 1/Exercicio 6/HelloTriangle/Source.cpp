...
//#endif
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Brunno Zonatto - Ex. 6", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform4f(colorLoc, 0.6f, 1.0f, 1.0f, 1.0f);
...
int setupGeometry()
{
	...
	float angle = 0;
	float deltaAngle = 2 * pi / (nPoints - 2);
	float radius = 0.5;
